...
const productList = [
  ...
  { id: '3', name: 'Portable Bluetooth Speaker', price: 1, imageUrl: 'https://placehold.co/200x200/90E0EF/03045E?text=Speaker', description: 'Powerful sound in a compact design, perfect for on-the-go.' },

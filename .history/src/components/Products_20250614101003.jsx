...
const productList = [
  ...
  { id: '2', name: 'Smartwatch', price: 1.99, imageUrl: 'https://placehold.co/200x200/ADE8F4/03045E?text=Smartwatch', description: 'Track your fitness and stay connected with this sleek smartwatch.' },
  { id: '3', name: 'Portable Bluetooth Speaker', price: 1.99, imageUrl: 'https://placehold.co/200x200/90E0EF/03045E?text=Speaker', description: 'Powerful sound in a compact design, perfect for on-the-go.' },

...
const productList = [
  ...
  { id: '2', name: 'Smartwatch', price: 1, imageUrl: 'https://placehold.co/200x200/ADE8F4/03045E?text=Smartwatch', description: 'Track your fitness and stay connected with this sleek smartwatch.' },
